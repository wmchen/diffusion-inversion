...
from inversions.unet_based.fpi import (SDInversionPipeline, SDXLInversionPipeline, CustomDDIMInversionScheduler, 
...
def parse_args():
    ...
    parser.add_argument("--num_iter_steps", type=int, default=20)
...
def main():
    ...
    axs[2].set_title(f"FPI ({psnr_score:.2f} dB)")
