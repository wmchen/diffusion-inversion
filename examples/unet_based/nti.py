...
from inversions.unet_based.nti import (SDInversionPipeline, SDXLInversionPipeline, CustomDDIMInversionScheduler, 
...
def parse_args():
    ...
    parser.add_argument("--num_optim_steps", type=int, default=10)
...
def main():
    ...
    axs[2].set_title(f"NTI ({psnr_score:.2f} dB)")
