...
from inversions.unet_based.edict import (SDInversionPipeline, SDXLInversionPipeline, CustomDDIMInversionScheduler, 
...
def main():
    ...
    axs[2].set_title(f"EDICT ({psnr_score:.2f} dB)")
