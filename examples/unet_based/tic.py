...
from inversions.unet_based.tic import (SDInversionPipeline, SDXLInversionPipeline, CustomDDIMInversionScheduler, 
...
def parse_args():
    ...
    parser.add_argument("--start_timestep", type=int, default=4)
    parser.add_argument("--start_layer_index", type=int, default=10)
...
def main():
    ...
    axs[2].set_title(f"TIC ({psnr_score:.2f} dB)")
