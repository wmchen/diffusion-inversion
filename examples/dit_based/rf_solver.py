...
from inversions.dit_based.rf_solver import (RFSolverFluxPipeline, FlowMatchEulerDiscreteInversionScheduler, 
...
def main():
    ...
    pipe = RFSolverFluxPipeline.from_pretrained(
        args.pretrained_model_name_or_path,
    ...
    print(f"[RF-Solver] PSNR: {psnr_score:.2f}, SSIM: {ssim_score:.4f}, LPIPS: {lpips_score:.4f}")
    ...
    axs[2].set_title(f"RF-Solver ({psnr_score:.2f} dB)")
