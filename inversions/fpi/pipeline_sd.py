...
class SDInversionPipeline(StableDiffusionPipeline):
    ...
    def inverse(
        ...
        **kwargs,
        ...
        with EmojiProgressBar(total=num_inference_steps, desc="Fixed-Point Inversion") as pbar:
            for i in range(num_inference_steps):
                ...
                for _ in range(num_iter_steps):
                    ...
                    latent_model_input = torch.cat([zt] * 2) if self.do_classifier_free_guidance else zt
                    ...
                    zt = self.scheduler.ddim_inverse_step(noise_pred, t, latents)
                latents = zt.clone()
