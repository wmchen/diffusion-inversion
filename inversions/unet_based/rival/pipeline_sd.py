...
class SDInversionPipeline(StableDiffusionPipeline):
    ...
    def inverse(
        ...
        **kwargs,
        ...
        # 8. Remove attention hook
        attn_hook.remove()

        # Offload all models
        self.maybe_free_model_hooks()

        return InversionPipelineOutput(zT=latents, cache_attentions=self_attentions, ori_image=image)
