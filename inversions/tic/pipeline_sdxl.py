...
from .hook import AttentionQKVHook, AttentionQKVInverter
...
class SDXLInversionPipeline(StableDiffusionXLPipeline):
    ...
    def inverse(
        ...
        **kwargs,
        ...
        print("Force prompt to empty string according to the paper")
        (
            prompt_embeds,
            negative_prompt_embeds,
            pooled_prompt_embeds,
        ...
        **kwargs,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i in range(num_inference_steps):
                t = timesteps[i]
                if i > start_timestep:
                    attn_inverter = AttentionQKVInverter(
                        unet=self.unet,
                        self_attn=cache_attentions[num_inference_steps-i-1],
                ...
                # remove attention inverter
                if i > start_timestep:
                    attn_inverter.remove()
